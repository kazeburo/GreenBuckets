...
is_deeply $nodes, [
    { object_id =>1, filename => 1, rid => 250, gid => 1, 
      id => 1, node => 'http://192.168.0.1/', can_read => 1, can_write => 1 },
    { object_id =>1, filename => 1, rid => 250, gid => 1,
      id => 2, node => 'http://192.168.0.2/', can_read => 1, can_write => 1 },
    { object_id =>1,  filename => 1, rid => 250, gid => 1,
      id => 3, node => 'http://192.168.0.3/', can_read => 1, can_write => 1 },
];
...
is_deeply $nodes2, [
    { object_id =>5, filename => 5, rid => 254, gid => 3, 
      id => 7, node => 'http://192.168.0.7/', can_read => 1, can_write => 0 },
    { object_id =>5, filename => 5, rid => 254, gid => 3, 
      id => 8, node => 'http://192.168.0.8/', can_read => 1, can_write => 1 },
    { object_id =>5, filename => 5, rid => 254, gid => 3, 
      id => 9, node => 'http://192.168.0.9/', can_read => 1, can_write => 1 },
#conflict objects
...
is_deeply $schema->select_fresh_nodes(having=>3), [
    { id => 1, gid => 1, node => 'http://192.168.0.1/', can_read => 1, can_write => 1 },
    { id => 2, gid => 1, node => 'http://192.168.0.2/', can_read => 1, can_write => 1 },
    { id => 3, gid => 1, node => 'http://192.168.0.3/', can_read => 1, can_write => 1 },
    { id => 4, gid => 2, node => 'http://192.168.0.4/', can_read => 1, can_write => 1 },
    { id => 5, gid => 2, node => 'http://192.168.0.5/', can_read => 1, can_write => 1 },
    { id => 6, gid => 2, node => 'http://192.168.0.6/', can_read => 1, can_write => 1 },
];
